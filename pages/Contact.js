...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Welcome to Digital Refraction. We're here to help small businesses like yours thirve with the latest technology and business solutions." }
  ]);
  ...
  return (
    ...
    <div className="prose max-w-none text-white font-ibm">
