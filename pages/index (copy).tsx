...
"can now be implemented at a fraction of the cost."
            ...
            {showButton && (
 <div className="text-center py-2 mt-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-20">
    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mt-4 rounded pulse">
      <a href="mailto:example@example.com?subject=I want to learn more about Digital Refraction &body=Body">Let's Discuss</a>
    </button>
              </div>
            )}
          </div>
